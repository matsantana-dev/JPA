        ...
        try  {
            ...
            switch(botao){
                ...
                case "remover":
                        ...
                        break;
                case "gravarpet":
                        request.getRequestDispatcher("GravarPet").forward(request, response);
                        break;
                case "alterarpet":
                        request.getRequestDispatcher("AlterarPet").forward(request, response);
                        break;
                case "removerpet":
                        request.getRequestDispatcher("RemoverPet").forward(request, response);
                        break;
                case "listarpet":
